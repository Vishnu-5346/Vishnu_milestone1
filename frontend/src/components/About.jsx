  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center max-w-3xl mx-auto mb-16">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">About the Platform</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
        ...
        <div className="bg-gradient-to-tr from-primary-50 to-secondary-50 dark:from-primary-950/20 dark:to-teal-950/20 p-8 rounded-2xl border border-primary-100 dark:border-primary-900/30 flex flex-col justify-center">
          <div className="flex items-center gap-3 mb-4">
            <BrainCircuit className="h-6 w-6 text-primary dark:text-primary-400" />
            <h3 className="text-lg font-bold text-gray-900 dark:text-white">Key Architectural Core</h3>
          </div>
