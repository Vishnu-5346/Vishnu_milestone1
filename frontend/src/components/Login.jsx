    ...
    <div className="max-w-md mx-auto my-16 px-4">
      <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-100">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-2">Sign in to your mass communication platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full bg-primary hover:bg-blue-700 text-white font-medium py-3 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm disabled:opacity-75 disabled:cursor-not-allowed"
          >
