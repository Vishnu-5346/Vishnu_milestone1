  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">Monitor read rates and user interaction metrics across channels</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {cards.map((card, index) => {
          ...
          return (
            <div key={index} className="bg-white dark:bg-[#1E293B] p-6 rounded-2xl border border-gray-100 dark:border-[#334155] shadow-sm">
              <div className="flex justify-between items-start mb-3">
                <span className="text-xs font-semibold text-gray-400 dark:text-gray-400 uppercase tracking-wider">{card.label}</span>
                <div className="p-2 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-[#1E293B] p-6 rounded-2xl border border-gray-100 dark:border-[#334155] shadow-sm">
          <h3 className="font-bold text-gray-900 dark:text-white mb-4 text-md">Readership by Language</h3>
        ...
        <div className="bg-white dark:bg-[#1E293B] p-6 rounded-2xl border border-gray-100 dark:border-[#334155] shadow-sm">
          <h3 className="font-bold text-gray-900 dark:text-white mb-4 text-md">Monthly Message Read Volume</h3>
          <div className="flex justify-between items-end h-40 pt-4 px-2">
            {[45, 60, 55, 70, 85, 95].map((val, idx) => (
              <div key={idx} className="flex flex-col items-center gap-2 w-1/6">
                <div className="w-8 bg-blue-500 dark:bg-[#3B82F6] hover:bg-blue-600 dark:hover:bg-[#2563EB] rounded-t-md transition-all duration-300" style={{ height: `${val}%` }}></div>
