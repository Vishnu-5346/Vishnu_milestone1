...
const Profile = () => {
  ...
  if (!user) {
    return (
      <div className="max-w-md mx-auto my-12 text-center p-8 bg-white rounded-2xl shadow border border-gray-100">
    ...
    <div className="max-w-2xl mx-auto my-12 px-4">
      <div className="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
        ...
        <div className="px-8 pb-8 relative">
          {/* Avatar container */}
          <div className="absolute -top-12 left-8 border-4 border-white bg-blue-100 rounded-full w-24 h-24 flex items-center justify-center text-primary shadow">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-800 font-medium">{joinDate}</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="inline-flex items-center mt-1 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-blue-50 text-primary-700">
                    {user.role}
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-800 font-medium">{user.language}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-800 font-medium">{user.organization}</p>
                </div>
              </div>
            </div>
          </div>
